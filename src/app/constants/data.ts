 export const hiddenRoutes = [ '/profile','/settings', '/page/register','/page/login',"/dashboard/financial-year", '/page/unautherized-access','/page/register','/page/forget-password','/forget-password'];
